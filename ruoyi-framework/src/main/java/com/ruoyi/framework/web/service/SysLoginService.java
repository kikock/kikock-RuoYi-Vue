...
public class SysLoginService{
    ...
    public String login(String username, String password, String code, String uuid){
        ...
        try {
            //处理前将前端密码解密
            String decryptPassword = RSAUtil.decryptByPrivateKey(password.trim().replaceAll(" ", "+"));
            // 验证码校验
            validateCaptcha(username, code, uuid);
            // 登录前置校验
            loginPreCheck(username, decryptPassword);
            UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(username, decryptPassword);
     ...
     * @return 结果
     */
    public String mockUser(String username, String password){
        // 用户验证
        Authentication authentication = null;
        try {
    ...
    public AjaxResult loginSocial(Long userId){
