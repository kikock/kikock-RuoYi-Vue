...
public interface IBpmProcessDefinitionService{
     ...
     * 获得流程定义列表
     *
     * @param bpmProcessDefinitionVo 列表入参
     * @return 流程定义列表
     */
    List<BpmProcessDefinitionVo> getProcessDefinitionList(BpmProcessDefinitionVo bpmProcessDefinitionVo);
     ...
     * @return 流程编号
     */
    String createProcessDefinition(@Valid BpmProcessDefinitionVo createReqDTO);
     ...
     * @return 是否相等
     */
    boolean isProcessDefinitionEquals(@Valid BpmProcessDefinitionVo createReqDTO);
