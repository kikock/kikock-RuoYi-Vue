...
public interface IWfProcessService {
     ...
     * 查询我的流程列表
     */
    List<WfTaskVo> selectPageOwnProcessList(ProcessQuery processQuery);
     ...
     * 查询代办任务列表
     */
    List<WfTaskVo> selectPageTodoProcessList(ProcessQuery processQuery);
     ...
     * 查询待签任务列表
     */
    List<WfTaskVo> selectPageClaimProcessList(ProcessQuery processQuery);
     ...
     * 查询已办任务列表
     */
    List<WfTaskVo> selectPageFinishedProcessList(ProcessQuery processQuery );
     ...
     * @param deployId 部署ID
     */
    WfDeployFormVo selectDeployFormContent(String definitionId, String deployId, String procInsId);
