package com.ruoyi.project.flowable.service;
...
public interface IFlowDefinitionService {
     ...
     * @return 流程定义分页列表数据
     */
    Page<FlowProcDefDto> list(String name, Integer pageNum, Integer pageSize, String deployTime);
     ...
     * @return  查询结果
     */
    List<FlowProcDefDto> selectDeployList(FlowProcDefDto dto);
}
