...
import com.ruoyi.project.flowable.domain.dto.FlowSaveXmlVo;
...
public class FlowDefinitionController {
    ...
    public AjaxResult list(@ApiParam(value = "当前页码", required = true) @RequestParam Integer pageNum,
                           ...
                           @ApiParam(value = "部署时间", required = false) @RequestParam(required = false) String deployTime) {
        return AjaxResult.success(flowDefinitionService.list(name,pageNum, pageSize,deployTime));
    }
    ...
    @PostMapping("/export")
    public void export(HttpServletResponse response, FlowProcDefDto dto) {
        List<FlowProcDefDto> flowProcDefDtos = flowDefinitionService.selectDeployList(dto);
        ExcelUtil<FlowProcDefDto> excelUtil = new ExcelUtil(FlowProcDefDto.class);
        excelUtil.exportExcel(response, flowProcDefDtos, "流程定义数据");
    }
